...
//
// Args:
//   world:  A pointer to a 2D array of characters where each character
//   represents
...
//   `errno` is set or the parsed value is less than 1, it's considered an
//   error.
...
//
// Args:
//   config: A pointer to the config_t structure where the settings are be
//   stored. argc:   The number of command-line arguments. args:   An array of
//   pointers to the strings which are those arguments.
//
// Returns:
...
//
// Args:
//   world:  A pointer to a 2D array representing the current state of the game
//   world. config: A pointer to the config_t structure containing the game
//   configuration,
